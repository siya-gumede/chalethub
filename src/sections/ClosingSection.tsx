...
export const ClosingSection: React.FC<ClosingSectionProps> = ({ onNavigate }) => {
  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="bg-image"
        style={{ 
          backgroundImage: 'url(/images/closing_interior.jpg)',
          opacity: 0.6,
      ...
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-chalet-black/80 via-chalet-black/40 to-chalet-black/60 z-[2]" />
